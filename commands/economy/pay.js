...
try {
  let user2 = message.author
    if (!args[0]) return message.channel.send("**Wskaż użytkownika któremu chcesz zapłacić!**");
    let user =
    ...
    let embed1 = new MessageEmbed()
      .setColor("GREEN")
      .setDescription(`❌ Wskaż użytkownika któremu chcesz zapłacić!`);
    ...
    let embed5 = new MessageEmbed()
      .setColor("GREEN")
      .setDescription(`❌ Jesteś biedny :frowning: `);
    ...
    let embed6 = new MessageEmbed()
      .setColor("GREEN")
      .setImage('https://media.giphy.com/media/YnkMcHgNIMW4Yfmjxr/giphy.gif')
      .setDescription(`✅ Zapłaciłeś łapówke ${user.displayName} ${args[1]} :dollar:`);
